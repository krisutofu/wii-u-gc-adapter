   ...
   while (1) {
      ...
      if (c == 'h') {
         ...
         fprintf(stdout,
            ...
            "\n");
         fprintf(stdout,
            "--shoulder-none            (default) emits events for TRIGGER buttons LT (BTN_TL2) and RT (BTN_TR2) when L or R are depressed fully, instead of SHOULDER buttons LB (BTN_TL) and RB (BTN_TR).\n"
